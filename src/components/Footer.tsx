...
// Generated: 2025-08-20T11:16:34.828Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Acme Consulting is a leading provider of SAP integration and business process optimization solutions. 
                We help enterprises streamline their operations and drive digital transformation.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Main St, Suite 500, Anytown USA</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest news, insights, and updates from Acme Consulting. Unsubscribe anytime.
              </p>
            </div>
          </div>
